...
| Inactivated members by latest reason | Why do members leave, and is it clinical or a contact problem? | _unassigned_ | _to agree_ | Blocked — Reason wording is transcribed from the existing dashboard and two labels were cut off in the source. Take the final wording from the inactivation reason picklist |
...
- **Inactivated members by latest reason** — Reason wording is transcribed from the existing dashboard and two labels were cut off in the source. Take the final wording from the inactivation reason picklist.
