...
- **What it takes from the reports that already exist.** **Provider satisfaction with Clinically AI** on the Provider journey is the only satisfaction figure in the prototype, and it is four pilot providers asked informally. There is no member survey at all.
...
- **A survey has to exist** — instrument, cadence, who is asked, and the threshold that counts as success. None of it is agreed; on 28 Aug 2026 the numbers said out loud were examples, not decisions.
