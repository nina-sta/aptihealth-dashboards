...
- **What it takes from the reports that already exist.** The Patient journey shows who falls out — inactivations, no-shows, drop-off by stage. It does not show what was done about it, which is where this report would start.
...
- **Discharge notification source** — payer feed, referrer notification or member self-report. Each gives post-discharge outreach a different denominator.
- **What counts as an outreach attempt** — undefined, and it is the unit this whole report would be built on.
