...
- **What it takes from the reports that already exist.** Nothing. No compensation measure exists anywhere in this prototype and no source system has been named, so this report starts from nothing rather than from a rearrangement.
...
- **Source** — no compensation data source has been named.
- **Who may see it** — pay-level figures in a report this many people open is a decision to take before the first tile, not after.
